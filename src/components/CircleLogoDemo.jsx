        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Circle Agiledge Logo
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              A modern logo featuring the distinctive "g" in a circle with gradient colors, creating a unique and memorable brand identity.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="text-xl font-semibold text-gray-900 mb-4">Circle Design</h4>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mr-3 mt-2"></div>
                      <span className="text-gray-700">Distinctive "g" enclosed in a gradient circle</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mr-3 mt-2"></div>
                      <span className="text-gray-700">Blue to purple to indigo gradient background</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mr-3 mt-2"></div>
                      <span className="text-gray-700">White "g" creates perfect contrast</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mr-3 mt-2"></div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">"Agile" and "edge" with gradient text</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-purple-500 rounded-full mr-3 mt-2"></div>
                    ...
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-purple-500 rounded-full mr-3 mt-2"></div>
                      <span className="text-gray-700">Creates visual break in "Agiledge"</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <code className="text-sm text-gray-600">
                      &lt;CircleAgiledgeLogo size="large" className="my-custom-class" /&gt;
                    </code>
                  </div>
